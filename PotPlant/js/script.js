...
function addItemsToSelectedProducts(productIndex) {
    addToCartBtn[productIndex].style.background = '#62BD69';
...
function activeFavoriteItemAddToCartBtn(productIndex) {
    let favoriteItemAddToCartBtn = newfavoriteItem[productIndex].children[3].children[3].children[0];
    favoriteItemAddToCartBtn.style.background = '#62BD69';
...
function deactiveFavoriteItemAddToCartBtn(productIndex) {
    let favoriteItemAddToCartBtn = newfavoriteItem[productIndex].children[3].children[3].children[0];
    favoriteItemAddToCartBtn.style.background = '#16191a';
...
function addItemsToFavoriteProducts(productIndex) {
    favoriteIcon[productIndex].style.background = '#62BD69';
